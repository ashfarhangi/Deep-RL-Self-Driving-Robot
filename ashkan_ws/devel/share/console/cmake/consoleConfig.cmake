...
if("TRUE" STREQUAL "TRUE")
  set(console_SOURCE_PREFIX /home/ashkan/git/Deep-RL-Self-Driving-Robot/ashkan_ws/src/f1tenth/console)
  set(console_DEVEL_PREFIX /home/ashkan/git/Deep-RL-Self-Driving-Robot/ashkan_ws/devel)
  set(console_INSTALL_PREFIX "")
  set(console_PREFIX ${console_DEVEL_PREFIX})
else()
  set(console_SOURCE_PREFIX "")
  set(console_DEVEL_PREFIX "")
  set(console_INSTALL_PREFIX /home/ashkan/git/Deep-RL-Self-Driving-Robot/ashkan_ws/install)
...
if(NOT " " STREQUAL " ")
  ...
  foreach(idir ${_include_dirs})
    ...
    elseif("${idir} " STREQUAL "include ")
      ...
      message(FATAL_ERROR "Project 'console' specifies '${idir}' as an include dir, which is not found.  It does neither exist as an absolute directory nor in '/home/ashkan/git/Deep-RL-Self-Driving-Robot/ashkan_ws/src/f1tenth/console/${idir}'.  ${_report}")
    endif()
